...
- [Metrics that measure impossible states](project_unsatisfiable_metrics.md) — two accepted-ADR acceptance criteria were unsatisfiable/unreachable. Prove satisfiability and name the mechanism first.
